...
$slot= $_POST['Slot'];
                ...
                $result = mysqli_query($conn,"DELETE FROM `h_reservation` WHERE Date='$date' AND Slot='$slot' AND status='0'");
                if($result)
                {
                    echo"done";
...
<body>
  ...
  <section id="hero" class="hero d-flex align-items-center">
        ...
        <div class="login_box">
          ...
          <form class="logform" method="post" action="admin8.php" >
                     
              <div class="login-box">

                    
                      <h3>Delete Unconfirmed</h3>
                      </div>
                      ...
                      <h6>Select Date</h6>
                        ...
                        <br>
                      <button class="submit" type="submit" name="select">Submit</button>
            </div>
