...
<body>
  ...
  <form class="logform" method="post" action="resetpass.php" >
    ...
    <button class="submit" type="submit" name="checkpass"> Update</button>
         ...
         $cpassword =$_POST['cpassword'];
           ...
           else
           {
            $Email=$_SESSION['email'];
             $update_pass = "UPDATE customer_details SET password = '$password' WHERE Email = '$Email'";
              $run_query = mysqli_query($conn, $update_pass);

              if($run_query)
              {
                 echo '<script type="text/javascript">alert("Changed Password Successfully ! Now Login Again")</script>';
