<?php
    ...
    if(isset($_POST['Add_item']))
    {
        ...
        $sql ="INSERT INTO `addcart`(`LID`,`RID`,`username`, `Name`,`Price`,`Quantity`,`M_date`) VALUES ('$id','$rid','$name','$Item','$Price','$Number','$Date')";
  ...
  <header id="header" class="header fixed-top">
   ...
   <img src="logo.png" alt="" >
      ...
      <nav id="navbar" class="navbar">
       ...
       <?php echo $rid; ?> </span> <i class="bi bi-chevron-down"></i></a>
            <ul>
...
<input type='hidden' name='Item' value='<?php echo$rid;?>'>
...
<tbody>
    <tr>
     ...
     <input type='hidden' name='Item' value='<?php echo $row["Name"];?>'>
          ...
          <input type='hidden' name='rid11' value='<?php echo$rid;?>'>
