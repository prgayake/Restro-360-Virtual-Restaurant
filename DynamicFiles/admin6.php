<?php
    ...
    if(isset($_POST['Add_item']))
    {
      ...
      $Price=$Price * $Number;
            ...
            $sql ="INSERT INTO `addcart`(`LID`,`username`, `Name`, `Price`, `Quantity`,`M_date`) VALUES ('$id','$id1','$Item','$Price','$Number','$Date')";
...
$date= $_POST['date'];
                ...
                $result = mysqli_query($conn,"SELECT LID FROM h_reservation  WHERE ID='$date' ");
                if($result)
                {
                    echo"done";
                ...
                $result = mysqli_query($conn,"SELECT username FROM h_reservation  WHERE ID='$date' ");
                if($result)
                {
                    echo"done";
                    while($rows = mysqli_fetch_assoc($result))
...
<body>
 ...
 <?php echo $id1; ?> </span> <i class="bi bi-chevron-down"></i></a>
            <ul>
...
<tbody>
    <tr>
     ...
     <td>
          ...
          <input type='hidden' name='username' value='<?php echo$id1;?>'>
