...
function myFunction() {
  ...
  <div class="user-box">
    ...
    <div class="user-box">
      ...
      <textarea type="text" name="request" placeholder="Write Your honest FeedBack" required="" style="width: 500px;height: 150px; margin-bottom: 20px; border-color: black;"></textarea>
    ...
    <button class="btn btn_primary" type="submit" name="SEND"> SUBMIT</button>
