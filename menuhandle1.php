...
<body>
  ...
  <form class="logform" method="post" action="menuhandle3.php" >
    <h1>Add menu<?php  echo$mid; ?></h1>
     <div class="login-box">
...
<input type='hidden' name='mid' value='<?php echo$mid;?>'>
    ...
    <button class="btnn" type="submit" name="show1">Submit</button>
      <br>
      <br>
