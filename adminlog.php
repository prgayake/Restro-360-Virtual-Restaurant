...
<body>
  ...
  <form class="logform" action="adminlog.php" method="post" >
    <h1>Sign in </h1>
     <div class="login-box">

  <form action="" method="post">
    <p>Enter Registred Email  To Get OTP</p>
        <br><br><br>
    <div class="user-box">
...
include('connect.php');
    ...
    if(isset($_POST['LOGIN']))
    {
      ...
      $result =mysqli_query($conn,"SELECT * from Adminlog where Email='$email'");
      
     if($result)
     {
 
      $sql = mysqli_query($conn,"UPDATE Adminlog
              SET OTP ='$code'
              WHERE Email ='$email'");
                ...
                $mail->Body    = "Dear  'Pradyumna ' Your One time Password for Admin Logiin  is :  ".$code."Thanks Regards : Virtuals Hotels :) ";
                $mail->AltBody = ' ';
     ...
     echo '<script type="text/javascript">
      ...
      {
        echo '<script type="text/javascript">
                      alert("Email is Not Correct ! try Again")
                </script>';;
      }
